        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink2.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink3.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink4.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Rp 5.000</p>
              <a href="Payment_Pages/paymentDrink5.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink6.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
      </div>
