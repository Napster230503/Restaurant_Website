...
<html lang="en">
  ...
  <body>
    ...
    <div class="card" style="width: 30rem; margin: 20px auto">
      <img src="IMG/FrozenYog.jpg" alt="Frozen yogurt" />
      <div class="card-body">
        <center>
          <h3 style="color: #f48901">Frozen yoghurt</h3>
          <h5>Rp15.000</h5>
        </center>

        <form action="post" class="mt-5">
          <h5>Jumlah Frozen Yoghurt</h5>
    ...
    <script>
      function mult() {
        ...
        let harga = Number(eskrim.value) * 15000;
