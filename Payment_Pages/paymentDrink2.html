...
<html lang="en">
  ...
  <body>
    ...
    <div class="card" style="width: 30rem; margin: 20px auto">
      <img src="IMG/jusMangga.jpg" alt="jus mangga" />
      <div class="card-body">
        <center>
          <h3 style="color: #f48901">Jus mangga</h3>
          <h5>Rp15.000</h5>
        </center>
        ...
        <form action="post" class="mt-5">
          ...
          <button type="button" class="btn btn-danger mt-4 ms-5"><a href="drink.html" style="color: white; text-decoration: none">Batal</a></button>
        </form>
      </div>
    </div>
    ...
    <script>
      function mult() {
        ...
        let harga = Number(minuman.value) * 15000;
