...
<html lang="en">
  ...
  <body>
    ...
    <div class="card" style="width: 30rem; margin: 20px auto">
      <img src="IMG/spageti.jpg" alt="Spagetti" />
      <div class="card-body">
        <center>
          <h3 style="color: #f48901">Spagetti</h3>
          <h5>Rp30.000</h5>
        </center>
        ...
        <form action="post" class="mt-5">
          ...
          <h5 class="mt-5">Pilih saus</h5>

          <input type="radio" name="saus" value="sausTomat" required="" />
          <label for="pedesMampus">Saus Tomat</label>
          <input type="radio" class="ms-4" name="saus" value="sausPedas" required="" />
          <label for="pedesgila">Saus Pedas</label>
    ...
    <script>
       function mult() {
        ...
        let harga =  Number(makanan.value) * 30000;
