        ...
        <div class="col-sm mb-5 ms-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentIce.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5 ms-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Rp.10.000</p>
              <a href="Payment_Pages/paymentIce2.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5 ms-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentIce3.html" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
      </div>
