        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink2.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink3.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink4.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Rp 5.000</p>
              <a href="Payment_Pages/paymentDrink5.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm mb-5">
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="Payment_Pages/paymentDrink6.php" class="btn btn-warning">Pesan</a>
            </div>
          </div>
        </div>
      </div>
